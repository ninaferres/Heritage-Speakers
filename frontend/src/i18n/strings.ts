...
export const EN: Record<StringKey, string> = {
  ...
  'host.name': 'Meet Nina',
  'host.bio': 'I grew up in a family where we spoke Spanish, Catalan, and Russian. I use Spanish and Catalan every day here in Catalonia, but Russian is the language I only speak with my mother and my maternal grandmother. It\'s that language, the one that connects me to my roots, that inspired me to build Heritage Speakers. I know what it feels like to understand a language but struggle to speak it fluently. I know the fear of losing it. That\'s why I created this: so your heritage language stays alive, not something you lose.',
  'about.eyebrow': 'About Heritage Speakers',
  'about.title': 'Built by someone who gets it',
  'about.ninaStory': 'I\'m Nina. My heritage isn\'t just something I have, it\'s something I am. I grew up speaking three languages at home: Spanish with my parents, Catalan with my friends here, and Russian with my mother and my maternal grandmother. That\'s who I am. But as I got older, Russian started slipping away. I could still understand when my grandmother spoke, but I couldn\'t answer back fluently. I couldn\'t read it. Writing felt impossible. And it broke my heart a little each time.',
...
export const ES: Record<StringKey, string> = {
  ...
  'host.bio': 'Crecí en una familia donde hablábamos español, catalán y ruso. Uso español y catalán todos los días aquí en Cataluña, pero el ruso es el idioma que solo hablo con mi madre y mi abuela materna. Es ese idioma, el que me conecta con mis raíces, lo que me inspiró a crear Heritage Speakers. Sé lo que se siente entender un idioma pero luchar por hablarlo con fluidez. Conozco el miedo a perderlo. Por eso creé esto: para que tu idioma de herencia siga vivo, no algo que pierdas.',
  'about.eyebrow': 'Acerca de Heritage Speakers',
  'about.title': 'Construido por alguien que lo entiende',
  'about.ninaStory': 'Soy Nina. Mi herencia no es solo algo que tengo, es algo que soy. Crecí hablando tres idiomas en casa: español con mis padres, catalán con mis amigos aquí, y ruso con mi madre y mi abuela materna. Eso es quien soy. Pero a medida que crecí, el ruso se empezó a desvanecer. Seguía entendiendo cuando mi abuela hablaba, pero no podía responder con fluidez. No podía leerlo. Escribir era casi imposible. Y eso me rompía un poco cada vez.',
  ...
  'about.ninaCall': 'Por eso existe Heritage Speakers. No para enseñarte un idioma nuevo. Para ayudarte a reclamar uno que ya está en tu corazón. Para darte cuatro habilidades sólidas donde tal vez tienes una o dos. Para que finalmente puedas marcar esa casilla en tu CV sin dudar. Para que puedas llamar a tu abuela y no solo escuchar, puedas responder. Realmente hablar. Para eso es esto.',
