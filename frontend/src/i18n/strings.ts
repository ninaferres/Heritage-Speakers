...
export const EN: Record<StringKey, string> = {
  ...
  'host.name': 'Meet Nina',
  'host.bio': 'I grew up in a family where we spoke Spanish, Catalan, and Russian. I use Catalan and Spanish every day here in Catalonia, but Russian is the language I only speak with my parents and my grandmother. It\'s that language, the one that connects me to my roots, that inspired me to build Heritage Speakers. I know what it feels like to understand a language but struggle to speak it fluently. I know the fear of losing it. That\'s why I created this: so your heritage language stays alive, not something you lose.',
  'about.eyebrow': 'About Heritage Speakers',
  'about.title': 'Built by someone who gets it',
  'about.ninaStory': 'I\'m Nina. My heritage isn\'t just something I have, it\'s something I am. I grew up speaking three languages at home: Catalan with my parents, a mix of Catalan and Spanish with my friends, and Russian with my parents and my grandmother. That\'s who I am. But as I got older, Russian started slipping away. I could still understand when my parents and grandmother spoke, but I couldn\'t answer back fluently. I couldn\'t read it. Writing felt impossible. And it broke my heart a little each time.',
  'about.ninaVision': 'I started noticing a pattern. Every friend I had with a heritage language described the same struggle: we understood everything, these languages were woven into how we grew up, yet we couldn\'t express ourselves fully. We were caught between native comprehension and hesitant, effortful speech, and for a long time that gap felt impossible to close. Then I realized it wasn\'t impossible. It simply needed the right approach, developed by someone who truly understands what it feels like to have a heritage language and to feel it slipping away.',
  'about.ninaWhyRosa': 'Here\'s the truth: I built Heritage Speakers because I got tired of being dishonest on my CV. You know that moment when you\'re filling out your LinkedIn or resume and it asks for your language proficiency? I could never check "native" because, even though I know how to listen to and speak Russian, I couldn\'t write well and my reading was clunky. But I am a native speaker. I just needed to strengthen those other two skills. That\'s the moment we\'re building toward together: the one where you can finally, honestly say you have native proficiency across speaking, reading, writing, and listening. All four skills.',
  'about.ninaCall': 'That\'s why Heritage Speakers exists. Not to teach you a new language. To help you reclaim one that\'s already in your heart. To give you four solid skills where you might have one or two. So you can finally check that box on your CV without hesitation. So you can call your grandmother and not just listen, but truly talk back. That\'s what this is for.',
  ...
  'assessment.takes5Minutes': 'The test takes up to 10 minutes. You must clear each level to advance to the next, so answer as accurately as you can.',
  ...
  'assessSpeaking.play': 'Play',
  'assessSpeaking.pause': 'Pause',
...
export const ES: Record<StringKey, string> = {
  ...
  'host.bio': 'Crecí en una familia donde hablábamos español, catalán y ruso. Uso catalán y español todos los días aquí en Cataluña, pero el ruso es el idioma que solo hablo con mis padres y mi abuela. Es ese idioma, el que me conecta con mis raíces, lo que me inspiró a crear Heritage Speakers. Sé lo que se siente entender un idioma pero luchar por hablarlo con fluidez. Conozco el miedo a perderlo. Por eso creé esto: para que tu idioma de herencia siga vivo, no algo que pierdas.',
  'about.eyebrow': 'Acerca de Heritage Speakers',
  'about.title': 'Construido por alguien que lo entiende',
  'about.ninaStory': 'Soy Nina. Mi herencia no es solo algo que tengo, es algo que soy. Crecí hablando tres idiomas en casa: catalán con mis padres, una mezcla de catalán y español con mis amigos, y ruso con mis padres y mi abuela. Eso es quien soy. Pero a medida que crecí, el ruso se empezó a desvanecer. Seguía entendiendo cuando mis padres y mi abuela hablaban, pero no podía responder con fluidez. No podía leerlo. Escribir era casi imposible. Y eso me rompía un poco cada vez.',
  'about.ninaVision': 'Empecé a notar un patrón. Todos mis amigos con un idioma de herencia describían la misma dificultad: entendíamos todo, estos idiomas formaban parte de cómo crecimos, pero no podíamos expresarnos plenamente. Estábamos atrapados entre una comprensión nativa y un habla dudosa y forzada, y durante mucho tiempo esa brecha pareció imposible de cerrar. Entonces comprendí que no era imposible. Solo necesitaba el enfoque adecuado, desarrollado por alguien que realmente entiende lo que se siente al tener un idioma de herencia y sentir que se está perdiendo.',
  'about.ninaWhyRosa': 'Aquí va la verdad: construí Heritage Speakers porque me cansé de ser deshonesta en mi currículum. ¿Conoces ese momento en el que rellenas tu LinkedIn o tu CV y te preguntan por tu nivel de idioma? Nunca podía marcar "nativo" porque, aunque sé escuchar y hablar ruso, no podía escribir bien y mi lectura era lenta. Pero sí soy hablante nativa. Solo necesitaba fortalecer esas otras dos habilidades. Ese es el momento que estamos construyendo juntos: aquel en el que finalmente puedas decir, con honestidad, que tienes dominio nativo en habla, lectura, escritura y comprensión auditiva. Las cuatro habilidades.',
  'about.ninaCall': 'Por eso existe Heritage Speakers. No para enseñarte un idioma nuevo. Para ayudarte a reclamar uno que ya está en tu corazón. Para darte cuatro habilidades sólidas donde tal vez tienes una o dos. Para que finalmente puedas marcar esa casilla en tu CV sin dudar. Para que puedas llamar a tu abuela y no solo escuchar, sino responder de verdad. Para eso es esto.',
  ...
  'assessment.takes5Minutes': 'La prueba dura hasta 10 minutos. Debes superar cada nivel para avanzar al siguiente, así que responde con la mayor precisión posible.',
  ...
  'speaking.stopRecording': 'Detener',
  ...
  'assessSpeaking.play': 'Reproducir',
  'assessSpeaking.pause': 'Pausar',
