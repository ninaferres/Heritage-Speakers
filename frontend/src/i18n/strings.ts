...
export const ES: Record<StringKey, string> = {
  ...
  'about.ninaWhyRosa': 'Aquí va la verdad: construí Heritage Speakers porque me cansé de ser deshonesta en mi currículum. ¿Conoces ese momento en el que rellenas tu LinkedIn o tu CV y te preguntan por tu nivel de idioma? Nunca podía marcar "nativo" porque solo hablaba con fluidez. No podía escribir bien, mi lectura era lenta y mi comprensión auditiva tenía huecos. Pero sí soy hablante nativa. Solo necesitaba fortalecer las otras tres habilidades. Ese es el momento que estamos construyendo juntos: aquel en el que finalmente puedas decir, con honestidad, que tienes dominio nativo en habla, lectura, escritura y comprensión auditiva. Las cuatro habilidades.',
